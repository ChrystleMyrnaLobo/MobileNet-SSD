...
cls_num3=$(expr $1 \* 3)
cls_num6=$(expr $1 \* 6)
trainfile=example/${prefix}_MobileNetSSD_train.prototxt
testfile=example/${prefix}_MobileNetSSD_test.prototxt
deploybnfile=example/${prefix}_MobileNetSSD_deploy_bn.prototxt
deployfile=example/${prefix}_MobileNetSSD_deploy.prototxt
